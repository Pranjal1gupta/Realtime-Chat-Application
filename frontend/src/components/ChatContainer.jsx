      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => (
          ...
          >
            ...
            <div className={`chat-bubble flex flex-col gap-2 ${message.senderId === authUser._id ? "bg-primary text-primary-content" : "bg-base-200 text-base-content"} shadow-sm p-3 rounded-2xl`}>
              {message.image && (
                <img
                  src={message.image}
                  alt="Attachment"
