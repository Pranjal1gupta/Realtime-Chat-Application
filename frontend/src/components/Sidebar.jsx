    ...
    <aside className="h-full w-full lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold block text-lg">Messages</span>
        </div>
      ...
      <div className="overflow-y-auto w-full py-3 flex-1">
        {filteredAcceptedConnections.length > 0 && (
          <>
            <div className="block px-5 py-2 text-xs font-semibold text-base-content/60 uppercase">
              <div className="flex items-center gap-2">
        ...
        {incomingRequests.length > 0 && (
          <>
            <div className="block px-5 py-2 text-xs font-semibold text-base-content/60 uppercase mt-4">
              <div className="flex items-center gap-2">
            ...
            {filteredDiscoverUsers.map((user) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex ml-auto px-3 py-1.5 bg-primary text-primary-content rounded-lg text-sm font-medium hover:bg-primary/80 transition-all"
